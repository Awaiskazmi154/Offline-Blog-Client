...
// importing the { addBlog, deleteBlog} from ./actions/blog
...
// BlogForm Component
const BlogForm = ({ navigation, route }) => {
  ...
  const [images, setImages] = useState(route.params.attachments);
  ...
  // editting the blog using dispatch functions
  const submitBlog = (blog) => dispatch(addBlog(blog));
  const deleteBlogItem = (key) => dispatch(deleteBlog(key));
  ...
  // removeAttachments method to remove all the attachments from the blog item
        ...
        <ScrollView style={styles.scrollView}>
          ...
          <View style={styles.blogFormBox}>
            ...
            <View style={styles.blogAttachmentsBox}>
              ...
              {/* removeAttachments Icon */}
              <TouchableOpacity onPress={removeAttachments}>
                <Image
                  style={styles.deleteAttachmentsIcon}
            ...
            <TouchableOpacity
              onPress={() => {
                deleteBlogItem(route.params.key);
                submitBlog(blog);
                setImage(null);
                setImages([]);
                setBlog({
              ...
              <Image
                style={styles.editBlogIcon}
                source={require('../images/editblogbtn.png')}
                resizeMode="contain"
              />
            </TouchableOpacity>
          </View>
